...
import arrow from '../../assets/bi_arrow-right.png';
import './header.css';

const Header = () => {
    return (
        <div className='coinbase__header section__padding'>
            <div className='coinbase__header-content'>
                <div className='coinbase__header-contentstart'>
                    <p> <img src={btc} alt="bitcoin" placeholder='Jump start' />Jump start your portfolio<img src={arrow} alt="arrow" /></p>
                </div>
                <h1>Jump start <br />your crypto<br /> portfolio</h1>
                <h3>Coinbase is the easiest place to buy and sell<br /> cryptocurrency. Sign up and get started today.</h3>
                <div className='coinbase__header-content__input'>
                    <input type='email' placeholder="Email Address" />
                    <button type="button">Get Started</button>
                </div>
            </div>
            <div class="coinbase__header-content-image">
                <svg
                    width="680"
                    height="956"
                    viewBox="0 0 680 956"
